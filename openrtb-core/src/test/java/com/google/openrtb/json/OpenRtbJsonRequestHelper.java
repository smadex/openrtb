...
class OpenRtbJsonRequestHelper {
  ...
  private static String generateFullRequest(boolean isRootNative, boolean isNativeObject)
    ...
    OpenRtb.BidRequest.Device.Builder device = OpenRtb.BidRequest.Device.newBuilder()
        .setUa("Chrome")
        .setSua(OpenRtb.BidRequest.Device.UserAgent.newBuilder()
            .addBrowsers(OpenRtb.BidRequest.Device.UserAgent.BrandVersion.newBuilder()
                .setBrand("Chromium")
                .addVersion("112")
                .addVersion("0")
                .addVersion("5615")
            ...
            .addBrowsers(OpenRtb.BidRequest.Device.UserAgent.BrandVersion.newBuilder()
                ...
                .addVersion("0")
                .addVersion("0"))
            .setPlatform(OpenRtb.BidRequest.Device.UserAgent.BrandVersion.newBuilder()
                .setBrand("Android")
                .addVersion("10")
                .addVersion("0")
                .addVersion("0"))
            ...
            .setMobile(true)
            .setModel("LM-G710")
            .setSource(OpenRtb.UserAgentSource.CLIENT_HINTS_HIGH_ENTROPY))
